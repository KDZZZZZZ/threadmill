...
func TestManagerMetricsAndIdleSnapshotCoverRuntimeAndSubsystems(t *testing.T) {
	...
	for _, field := range []string{
		...
		`"exec_dependency_tracing":`,
		`"cmdcache_lookups":`,
		`"cmdcache_hits":`,
		`"cmdcache_stores":`,
		`"cmdcache_rejected":`,
		`"cmdcache_replay_errors":`,
		`"cmdcache_artifact_reflinks":`,
		`"cmdcache_reflink_bytes":`,
		`"cmdcache_artifact_copies":`,
		`"cmdcache_copied_bytes":`,
		`"cmdcache_verifications":`,
		`"cmdcache_verify_mismatches":`,
		`"cmdcache_saved_duration":`,
		`"vfs_overlay_files":0`,
		`"vfs_tombstones":0`,
